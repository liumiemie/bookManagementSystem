...
$(function () {
        ...
        if ($("#bookId").val() == '') {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $(".con-book table tbody").html(str); //点击修改执行事件
  ...
  $("#sear_byBookSort").click(function () {
    $("#cont").load("html/search_byBookSort.html", function () {
      //先显示所有图书的信息
      getAllBook(); //类别的点击事件，点击哪个类别就显示某个类别的信息
    ...
    $("#cont").load("html/check_borrowStatus.html", function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $(".con-book table tbody").html(str); //如果状态为yes为绿色  为no为红色
    ...
    $("#cont").load("html/DeleteBook.html", function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#delbtn span").css("cursor", "Pointer"); //删除数据
      ...
      btn.click(function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $(".author_cont table").html(str + str1); //清空输入框
    ...
    $("#cont").load("html/stu_search.html", function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          var li = $(".stu_findway ul").find('li'); //通过ID查询学生信息
    ...
    $("#cont").load("html/loaningRecord.html", function () {
      $.ajax({
        ...
        success: function (data) {
          ...
          $(".loan_cont table").html(str + str1); //显示未归还记录
    ...
    $("#cont").load("html/penalty.html", function () {
      $.ajax({
        ...
        success: function (data) {
          ...
          $(".penalty_cont table").html(str + str1); //通过学号查询
...
/***/ })
/******/ ]);
//# sourceMappingURL=main-c7c895b04921ea1e3736.js.map